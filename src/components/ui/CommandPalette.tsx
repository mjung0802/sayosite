...
const ITEMS: PaletteItem[] = [
  ...
  { label: 'tone-chat.tsx', description: 'Tone Chat — a tone-based chat application', route: '/projects/tone-chat', icon: '⚛' },
  { label: 'ngu-guide.tsx', description: 'NGU Idle Guide — a crowdsourced guide for the incremental idle game', route: '/projects/ngu-guide', icon: '⚛' },
  { label: 'happytohelp.tsx', description: 'I\'d be happy to help! — a game about being an AI assistant', route: '/projects/happytohelp', icon: '⚛' },
